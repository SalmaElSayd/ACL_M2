...
export class AcceptSlotLinkingRequest extends Component {
    constructor(props) {
        super(props)
    ...
    onSubmit(e) {
        ...
        axios.post('http://localhost:3001/coordinator/acceptSlotLinkingRequests', request, {headers: {authorisation: localStorage.getItem('jwtToken')}})
            .then(response => {
...
export default AcceptSlotLinkingRequest
